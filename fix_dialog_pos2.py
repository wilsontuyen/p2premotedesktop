...
start = content.find("        if is_parent_minimized or parent is None:")
end = content.find("    def trigger_cancel(self):")

if start != -1 and end != -1:
    new_block = """        if is_parent_minimized or parent is None:
...
"""
    ...
    print("Replaced logic via index")
else:
